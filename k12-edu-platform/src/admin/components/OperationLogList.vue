<template>
  <div class="op-log">
    <div class="op-log__toolbar">
      <el-input v-model="username" placeholder="用户名" clearable style="width: 160px" />
      <el-input v-model="module" placeholder="模块 resource / audit / user" clearable style="width: 180px" />
      <el-button size="small" @click="filterModule('resource')">资源</el-button>
      <el-button size="small" @click="filterModule('audit')">审核</el-button>
      <el-button size="small" @click="filterModule('user')">用户</el-button>
...
import { listOperationLogs, type OperationLog } from '@/admin/api/operationLogs'
